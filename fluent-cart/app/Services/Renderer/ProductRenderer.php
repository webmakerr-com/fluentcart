                ...
                <div class="fct-how-it-works-item">
                    <div class="d-flex align-items-center gap-3 p-3 border rounded-3 bg-white shadow-sm h-100">
                        ...
                        <div class="d-flex flex-column">
                            <span class="fw-semibold text-body"><?php esc_html_e('Add to Cart', 'fluent-cart'); ?></span>
                            <span class="text-muted small"><?php esc_html_e('Select your perfect option', 'fluent-cart'); ?></span>
                        </div>
                    </div>
                </div>
                <div class="fct-how-it-works-item">
                    <div class="d-flex align-items-center gap-3 p-3 border rounded-3 bg-white shadow-sm h-100">
                        ...
                        <div class="d-flex flex-column">
                            <span class="fw-semibold text-body"><?php esc_html_e('Place the Order', 'fluent-cart'); ?></span>
                            <span class="text-muted small"><?php esc_html_e('Secure checkout in seconds', 'fluent-cart'); ?></span>
                        </div>
                    </div>
                </div>
                <div class="fct-how-it-works-item">
                    <div class="d-flex align-items-center gap-3 p-3 border rounded-3 bg-white shadow-sm h-100">
                        ...
                        <div class="d-flex flex-column">
                            <span class="fw-semibold text-body"><?php esc_html_e('Instant Delivery', 'fluent-cart'); ?></span>
                            <span class="text-muted small"><?php esc_html_e('Confirmation right away', 'fluent-cart'); ?></span>
                        </div>
                    </div>
                </div>
            </div>
