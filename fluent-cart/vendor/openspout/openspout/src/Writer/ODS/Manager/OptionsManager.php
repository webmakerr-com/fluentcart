...
class OptionsManager extends OptionsManagerAbstract
{
    ...
    {
        return [Options::TEMP_FOLDER, Options::DEFAULT_ROW_STYLE, Options::SHOULD_CREATE_NEW_SHEETS_AUTOMATICALLY, Options::DEFAULT_COLUMN_WIDTH, Options::DEFAULT_ROW_HEIGHT, Options::COLUMN_WIDTHS];
    }
    /**
     * {@inheritdoc}
     */
