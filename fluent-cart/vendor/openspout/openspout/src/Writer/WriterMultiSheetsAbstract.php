...
use FluentCart\OpenSpout\Writer\Exception\SheetNotFoundException;
...
abstract class WriterMultiSheetsAbstract extends WriterAbstract
{
    ...
    {
        $this->throwIfWriterAlreadyOpened('Writer must be configured before opening it.');
        $this->optionsManager->setOption(Options::DEFAULT_COLUMN_WIDTH, $width);
    }
    /**
     * @throws WriterAlreadyOpenedException
     */
    ...
    {
        $this->throwIfWriterAlreadyOpened('Writer must be configured before opening it.');
        $this->optionsManager->setOption(Options::DEFAULT_ROW_HEIGHT, $height);
    }
    /**
