...
<div class="fc-single-product-page fc-single-product-page--fiverr" data-fluent-cart-single-product-page>
    <div class="fc-container py-4">
        <div class="row g-4">
                ...
                <div class="d-flex flex-column gap-4">
                    <section class="card shadow-sm">
                        <div class="card-body d-flex flex-column gap-4">
                            ...
                            <div class="d-lg-none">
                                <div class="fc-product-summary-card card shadow-sm" id="fc-mobile-product-summary" data-fluent-cart-product-summary>
            ...
            <aside class="col-lg-5 col-xl-4 d-none d-lg-block">
